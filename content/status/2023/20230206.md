...
date = "2023-02-06"
description = "Splitting the Bezier object into FixedBezier and AnimatedBezier with a custom deserializer, so the core can load an animated Lottie file made with Flow."
+++
